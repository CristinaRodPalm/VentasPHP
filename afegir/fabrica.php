	...
	<body>
		...
		<!-- One -->
			<section id="one" class="wrapper special">
				<div class="inner">
					<header class="major">
						<h2>Afegir nova fàbrica</h2>
					</header>
					
					<!-- AFEGIR FORM -->
							<form method="post" action="../insert/inFabrica.php">
								<div class="row uniform">
									...
									<div class="6u$ 12u$(xsmall)">
										<input type="text" name="propietari" placeholder="Propietari" />
									</div>
									...
									<div class="6u$ 12u$(xsmall)">
										<input type="text" name="comissio" placeholder="Comissió" />
									</div>
