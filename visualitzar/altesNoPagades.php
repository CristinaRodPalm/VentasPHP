					...
					<div class="table-wrapper">
						<table class="alt">
							...
							<tbody>
								<?php 			
									$beneficiTotal = 0;
									$query = "select *, f.codi as codi, c.nom as nomClient, c.cognoms as cognomsClient, g.nom as nomFabrica from factures f, clients c, fabriques g where f.id_client = c.codi and f.id_fabrica = g.codi and f.pagat = 0;";
