		...
		<!-- One -->
			<section id="one" class="wrapper special">
				<div class="inner">
					...
					<div class="table-wrapper">
						<table class="alt">
							...
							<tbody>
								<?php 			
									$beneficiTotal = 0;
									$query = "select *, f.codi as codi, c.nom as nomClient, c.cognoms as cognomsClient, g.nom as nomFabrica from factures f, clients c, fabriques g where f.id_client = c.codi and f.id_fabrica = g.codi;";
									...
									if(mysqli_num_rows($resultado) == 0) {
										...
										while($fila=mysqli_fetch_array($resultado)){
											...
											if($pagat == 0) echo "<tr style='background-color:#ff6666'>
											...
											else echo "<tr style='background-color:#80ff80'>
																	<td><strong>$import €</strong</td> 
																	<td><strong>$benefici €</strong</td> 
					...
					<input type="submit" value="Veure factures pagades" onclick ="location='altesPagades.php'" class="special button"/>
