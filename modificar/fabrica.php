...
<html>
	<head>
		<title>Modificació de fàbriques</title>
		<meta charset="utf-8" />
		...
		<!-- One -->
			<section id="one" class="wrapper special">
				<div class="inner">
					...
					<?php 
						$codiFabrica = $_GET['id'];
						$query = "select * from fabriques where codi = $codiFabrica;";
						$result = mysqli_query($con, $query);
						extract(mysqli_fetch_array($result));
						
	
						echo"
							<form method='post' action='../update/upFabrica.php?id=$codiFabrica'>
								<div class='row uniform'>
								<div class='6u$ 12u$(xsmall)'>
									<input type='text' name='nom' value=$nom />
								</div>
								<div class='6u$ 12u$(xsmall)'>
									<input type='text' name='propietari' value=$propietari />
								</div>
								<div class='6u$ 12u$(xsmall)'>
								...
								<div class='6u$ 12u$(xsmall)'>
									<input type='text' name='comissio' value=$comissio />
								</div>
						";
					...
					?>
							...
							<input type="submit" value="Tornar" class="alt" onclick ="location='../fabriques.php'"/>
